...
for sim_name in sim_names:
    ...
    halo_dict_file = os.path.join('/scratch/hc2347/pickles/nihao/',sim_name,'pickle_run1.p')
    try:
...
#         pickle.dump( halo_dict, open(halo_dict_file, 'wb') )
    #except:
     ...
     #   pass
pickle.dump( gal_dict, open('/scratch/hc2347/pickles/nihao/pickle_NIHAO_2.p','wb') )
